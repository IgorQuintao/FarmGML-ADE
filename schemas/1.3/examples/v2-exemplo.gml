...
<gml:FeatureCollection
    ...
    <gml:featureMember>
        <farm:RuralProperty gml:id="farm_RP_001">
            ...
            <farm:managerInfo>
                <farm:firstName>João</farm:firstName>
                <farm:surname>Silva</farm:surname>
            </farm:managerInfo>
            ...
            <farm:mainAgriculturalFocus>mixed</farm:mainAgriculturalFocus>
            <farm:farmProfile>
        ...
        <farm:AnnualCropArea gml:id="farm_crop_soy_2025">
            ...
            <farm:producesLot>
                <farm:HarvestedLot gml:id="harvest_2025_001">
                    ...
                    <farm:quantitySold uom="t">120.0</farm:quantit>
